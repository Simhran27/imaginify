...
const Checkout = ({
  ...
  const [isClient, setIsClient] = useState(false); // Track if it's on the client
  ...
  return (
    <form onSubmit={onCheckout}>
      ...
      {/* Use suppressHydrationWarning to avoid warnings if content differs between server and client */}
      {isClient && (
